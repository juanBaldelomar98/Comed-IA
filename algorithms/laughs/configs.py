...
from algorithms.laughs import models
from algorithms.laughs.utils import audio_utils
...
MODEL_PATH = os.getenv("MODEL_PATH", "algorithms/laughs/checkpoints/in_use/resnet_with_augmentation")
CONFIG = os.getenv("CONFIG", "resnet_with_augmentation")
DEVICE = os.getenv("CONFIG", "cpu")
MIN_LENGTH = float(os.getenv("MIN_LENGTH", "0.2"))
SAVE_TO_AUDIO_FILES = bool(os.getenv("SAVE_TO_AUDIO_FILES", "True"))
SAVE_TO_TEXTGRID = bool(os.getenv("SAVE_TO_TEXTGRID", "False"))
